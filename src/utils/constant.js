...
export const PROJECT = [
    ...
    },
    {
        ...
        "description": 'SPA приложение с подключением к API. Использована архитектура приложения FSD. Впервые использовал RTK Query и очень был доволен лаконичностью и удобством кода.',
        "linkRepository": 'https://github.com/Avanire/t1-intesive',
        "image": project8Image,
        "linkProject": '#',
